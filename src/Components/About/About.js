  ...
  return (
    <Row className="my-5">
      <Col xs={12} sm={12} lg={8}>
        ...
        <h4 className="mb-4">
          <span className="primaryText"> Skill Up</span> is maintained by a team
          of developers and designers. <br /> We have a growing team and if you
          are interested in teaming up with us. And love to share your skills
          with others, we would love to hear from you.
        </h4>
        <h1 className="my-3">What we do</h1>
        <h4 className="mb-4">
          <span className="primaryText"> Skill Up</span> is teaching platform.{" "}
          <br />
          We are a group of developers and designers, who teamed up and started
          an online teaching platform. <br />
      ...
      <Col className="mb-2" xs={12} sm={12} lg={4}>
        <h1 className="secondaryText">Popular Courses</h1>
